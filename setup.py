...
if sys.platform == "win32":
    extra_objects = ["Ws2_32.Lib", "Wldap32.Lib", "Crypt32.Lib", "libssl.lib", "libcrypto.lib"]
    extra_compile_args.append("-IC:\Program Files\OpenSSL-Win64\include")
    extra_link_args.append('/LIBPATH:C:\Program Files\OpenSSL-Win64\lib')
else:
    extra_compile_args.append("-std=c++0x")
    extra_link_args.append("-lssl")


# Construct extension object. Here I've removed all the visual studio c++ 2019 unsupported flags
ext = Extension(
    '_quickfix',
    glob.glob('C++/*.cpp'),
    include_dirs=["C++"],
